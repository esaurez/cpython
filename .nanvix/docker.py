...
def _generate_setup_local_cmd() -> str:
    ...
    return (
        ...
        f"'# Phase 2: Tier-2 modules with bundled-in-cpython C deps. The' "
        f"'# bundled .a (libmpdec, libexpat, libHacl_Hash_SHA2) stay in' "
        f"'# python.elf via --whole-archive and dlopened .so resolves their' "
        f"'# symbols via main exe .dynsym at runtime.' "
        ...
        f"'_sha2 sha2module.c -I$(srcdir)/Modules/_hacl/include Modules/_hacl/libHacl_Hash_SHA2.a' "
